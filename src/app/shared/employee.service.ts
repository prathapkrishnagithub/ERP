...
import { Designation, Epmloyee } from '../shared/employee.model';
...
export class EmployeeService {
  ...
  employeeUrl:string='https://localhost:44356/api/Employee';
  designationUrl:string='https://localhost:44356/api/Designation';
